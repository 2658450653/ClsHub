...
def get_args_parser():
    ...
    # multimodal data
    parser.add_argument('--multimodal', default=True,
    ...
    parser.add_argument('--train_interpolation', type=str, default=InterpolationMode.BICUBIC,
...
def main(args):
    ...
    # print("***********1*******\n")
    print(args.weight_decay, args.weight_decay_end, args.epochs, num_training_steps_per_epoch)
    ...
    if args.eval:
        ...
        test_stats = evaluate(data_loader_val, model, device, use_amp=args.use_amp,
                                  classes=classes, multi_func=args.multi_func if args.multimodal else None)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            use_amp=args.use_amp, classes=classes, multi_func=args.multi_func if args.multimodal else None
        )
