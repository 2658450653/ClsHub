...
@register_model
def vit_b_16(*, pretrained=True, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    if pretrained:
...
@register_model
def vit_b_32(*, pretrained=False, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    if pretrained:
        weights = ViT_B_32_Weights.verify(ViT_B_32_Weights.IMAGENET1K_V1)
    else:
        weights = None
...
@register_model
def vit_l_16(*, pretrained=False, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    if pretrained:
        weights = ViT_L_16_Weights.verify(ViT_L_16_Weights.IMAGENET1K_V1)
    else:
        weights = None
...
@register_model
def vit_l_32(*, pretrained=False, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    if pretrained:
        weights = ViT_L_32_Weights.verify(ViT_L_32_Weights.IMAGENET1K_V1)
    else:
        weights = None
...
@register_model
def vit_h_14(*, pretrained=False, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    if pretrained:
        weights = ViT_H_14_Weights.verify(ViT_H_14_Weights.IMAGENET1K_V1)
    else:
        weights = None
...
if __name__ == '__main__':
    ...
    model = vit_b_16(pretrained=False, num_classes=100)
    out = model(data)
    print(out.shape)