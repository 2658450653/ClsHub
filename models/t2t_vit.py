...
default_cfgs = {
    'T2t_vit_7': _cfg('https://github.com/yitu-opensource/T2T-ViT/releases/download/main/71.7_T2T_ViT_7.pth.tar'),
    'T2t_vit_10': _cfg('https://github.com/yitu-opensource/T2T-ViT/releases/download/main/75.2_T2T_ViT_10.pth.tar'),
    'T2t_vit_12': _cfg('https://github.com/yitu-opensource/T2T-ViT/releases/download/main/76.5_T2T_ViT_12.pth.tar'),
    'T2t_vit_14': _cfg('https://github.com/yitu-opensource/T2T-ViT/releases/download/main/81.5_T2T_ViT_14.pth.tar'),
    'T2t_vit_19': _cfg('https://github.com/yitu-opensource/T2T-ViT/releases/download/main/81.9_T2T_ViT_19.pth.tar'),
    'T2t_vit_24': _cfg(),
    'T2t_vit_t_14': _cfg('https://github.com/yitu-opensource/T2T-ViT/releases/download/main/81.7_T2T_ViTt_14.pth.tar'),
    'T2t_vit_t_19': _cfg(),
    'T2t_vit_t_24': _cfg(),
...
if __name__ == '__main__':
    ...
    model = t2t_vit_14(pretrained=False, num_classes=100)
    out = model(data)
    print(out.shape)