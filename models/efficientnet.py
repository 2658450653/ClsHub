...
def efficientnet_b5(
    *, pretrained=False, progress: bool = True, **kwargs: Any
    ...
    if pretrained:
        weights = EfficientNet_B5_Weights.verify(EfficientNet_B5_Weights.IMAGENET1K_V1)
    else:
        weights = None
...
def efficientnet_b6(
    *, pretrained=False, progress: bool = True, **kwargs: Any
    ...
    if pretrained:
        weights = EfficientNet_B6_Weights.verify(EfficientNet_B6_Weights.IMAGENET1K_V1)
    else:
        weights = None
...
def efficientnet_b7(
    *, pretrained=False, progress: bool = True, **kwargs: Any
    ...
    if pretrained:
        weights = EfficientNet_B7_Weights.verify(EfficientNet_B7_Weights.IMAGENET1K_V1)
    else:
        weights = None
...
def efficientnet_v2_m(
    *, pretrained=False, progress: bool = True, **kwargs: Any
    ...
    if pretrained:
        weights = EfficientNet_V2_M_Weights.verify(EfficientNet_V2_M_Weights.IMAGENET1K_V1)
    else:
        weights = None
...
if __name__ == '__main__':
    ...
    model = efficientnet_v2_l(pretrained=True, num_classes=100)
    out = model(data)
    print(out.shape)