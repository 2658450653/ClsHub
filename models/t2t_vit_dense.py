...
from models.transformer_block import Mlp, Block, get_sinusoid_encoding
from models.t2t_vit import T2T_module, _cfg
...
if __name__ == '__main__':
    ...
    model = t2t_vit_dense(pretrained=True, num_classes=100)
    out = model(data)
    print(out.shape)